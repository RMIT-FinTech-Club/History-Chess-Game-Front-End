    ...
    return (
        <div className="text-white relative">
            ...
            <div className="flex justify-around items-center md:flex-row flex-col mb-[5dvh]">
                <div className="border border-white border-solid w-[80vw] md:w-[35vw] overflow-hidden rounded-[4vw] mb-[5dvh] md:mb-0 flex flex-col bg-[linear-gradient(180deg,#E9B654,#363624)] cursor-pointer">
