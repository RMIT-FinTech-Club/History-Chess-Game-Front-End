    ...
    return (
        <div className="text-white relative h-[calc(100dvh-var(--navbar-height))] flex justify-center items-center">
            ...
            <div className={`${styles.container} w-full md:h-[max-content] h-full grid`}>
                <div className={`${styles.item1} border border-white border-solid overflow-hidden rounded-[4vw] flex flex-row md:flex-col bg-[linear-gradient(180deg,#E9B654,#363624)] cursor-pointer`}>
                ...
                <div className={`${styles.item2} border border-white border-solid overflow-hidden rounded-[4vw] flex flex-row md:flex-col bg-[linear-gradient(180deg,#E9B654,#363624)] cursor-pointer`}>
                    <div className={`w-[40vw] md:w-full aspect-square bg-center bg-cover bg-no-repeat ${styles.chessboardBG}`}></div>
                    <div className="flex flex-col items-start justify-center">
