    ...
    return (
        <div className="text-white relative h-[calc(100dvh-var(--nav-height))] flex justify-center items-center">
            ...
            <div className={`${styles.container} grid h-full w-full place-items-center`}>
                <div className={`${styles.item1} border border-white border-solid w-[80vw] md:w-[50vh] overflow-hidden rounded-[4vw] flex flex-row md:flex-col bg-[linear-gradient(180deg,#E9B654,#363624)] cursor-pointer`}>
                ...
                <div className={`${styles.item2} border border-white border-solid w-[80vw] md:w-[50vh] overflow-hidden rounded-[4vw] flex flex-row md:flex-col bg-[linear-gradient(180deg,#E9B654,#363624)] cursor-pointer`}>
                    <div className={`w-full aspect-square bg-center bg-cover bg-no-repeat ${styles.chessboardBG}`}></div>
                    <div className="flex flex-col items-start justify-center">
