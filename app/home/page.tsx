    ...
    return (
        <div className="text-white relative min-h-screen flex flex-col items-center justify-center">
            ...
            <div className="flex flex-col md:flex-row justify-around items-stretch w-full max-w-6xl px-4">
                <div className="border border-white border-solid w-full md:w-[30vw] overflow-hidden rounded-[4vw] mb-[5dvh] md:mb-0 flex flex-col bg-[linear-gradient(180deg,#E9B654,#363624)] cursor-pointer min-h-[400px]">
                ...
                <div className="border border-white border-solid w-full md:w-[30vw] overflow-hidden rounded-[4vw] flex flex-col bg-[linear-gradient(180deg,#E9B654,#363624)] cursor-pointer min-h-[400px]">
                    <div className={`w-full aspect-square bg-center bg-cover bg-no-repeat ${styles.chessboardBG}`}></div>
                    <div className="flex flex-col items-start justify-center flex-1 p-4">
