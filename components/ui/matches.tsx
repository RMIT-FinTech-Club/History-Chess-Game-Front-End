...
export default function Matches({ isOpen }: MatchesProps) {
  return (
    <div>
      ...
      <div
        className={`flex flex-col w-full ${
          isOpen
            ? "h-[calc(100vh-12vw-3vh-2px-3vh-14vw-6vh-6vw-3vh)]"
            : "h-[calc(100vh-3vh-3vh-14vw-6vh-6vw-3vh)]"
        } overflow-y-auto mt-[2vh] transition-all duration-300 ${
      ...
      >
        {matches.map((match, index) => (
          <div
            key={index}
            className={`${index !== matches.length - 1 ? "mb-[3vh]" : "mb-0"} ${
              styles.match
              ...
              <div className="w-[22vw] md:w-[16vw] flex justify-center items-center">
                <p
                  className={`text-[1.5vw] px-[2vw] mr-[1vw] relative ${
                    match.victory ? "text-[#1CFF07]" : "text-[#EA4335]"
