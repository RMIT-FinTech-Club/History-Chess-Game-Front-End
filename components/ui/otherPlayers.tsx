...
export default function OtherPlayers({ isOpen }: OtherPlayersProps) {
  return (
    <div className="p-[2vw] w-full h-[100%] hidden md:flex flex-col bg-[#1D1D1D] rounded-[2vw]">
      ...
      <div className={`flex flex-col w-full ${isOpen ? 'h-[calc(100vh-12vw-3vh-2px-3vh-14vw-6vh-6vw-3vh)]' : 'h-[calc(100vh-3vh-3vh-14vw-6vh-6vw-3vh)]'} overflow-y-auto overflow-x-hidden transition-all duration-300 ${styles.list_container}`}>
