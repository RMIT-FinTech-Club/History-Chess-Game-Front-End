...
export default function Title() {
    return (
        <div className={`grid place-items-center relative text-white mb-[20vh] md:mb-[30vh] w-full h-[100dvh] overflow-x-clip`}>
            ...
            <img src="https://premierchessacademy.com/wp-content/uploads/2025/01/bigstock-208614778-1024x683-1.jpg" alt="FinTech Chess" className={`${styles.bg} absolute grid-column-[1/-1] inset-0 w-full h-full object-cover z-[-1] brightness-50`} />
        </div>
    )
}