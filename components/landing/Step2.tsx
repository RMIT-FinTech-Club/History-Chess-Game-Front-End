...
export default function Step2() {
    return (
        <div className={`flex flex-col justify-center items-center text-white my-[3dvh] md:my-[5dvh] ${styles.auto_blur}`}>
            <p className="md:text-[2.2rem] sm:text-[3.5rem] text-[2.5rem] text-center font-extrabold mb-[2dvh] w-[90vw]">Step 2: Challenge Other Players</p>
            <div className="flex flex-col justify-center items-start bg-[#1D1D1D] p-[5vw] md:p-[2vw] rounded-[5vw] md:rounded-[2vw] w-[90vw] md:w-[60vw]">
                ...
                {Array.from({ length: 5 }).map((_, index) => (
                    <div key={index} className="w-full my-[2dvh] flex justify-between items-center">
