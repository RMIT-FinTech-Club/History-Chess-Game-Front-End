        ...
        >
            <div className="flex flex-col justify-center items-center text-white my-[3vh] md:my-[5vh]">
                <div className="flex flex-col justify-center items-center">
                    <p className="md:text-[2.2rem] sm:text-[3.5rem] text-[2.5rem] text-center font-extrabold w-[90vw]">What is <span className={`text-gold-hover relative ${styles.title}`}><span className={`${styles.line}`}></span>FinTech History Chess Game</span>?</p>
